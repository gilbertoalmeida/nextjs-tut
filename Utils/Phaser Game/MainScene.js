...
import ScoreValue from "../../components/Phaser Game/ScoreValue"
...
export class MainScene extends Phaser.Scene {
  ...
  create() {
    ...
    const ScoreComp = () => (
      <ScoreValue scene={this} />
    )

    const scoreDiv = document.getElementById("reactScore")

    const react = this.add.dom(0, 0, scoreDiv)
    render(<ScoreComp />, react.node)
  ...
  collectStar(player, star) {
    ...
    this.events.emit('REACT_EVENT', { action: 'STAR_COLLECTED' })
